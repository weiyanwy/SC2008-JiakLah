...
class AppStateNotifier extends ChangeNotifier {
  FoodiezFirebaseUser? initialUser;
  FoodiezFirebaseUser? user;
  ...
  void update(FoodiezFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => UserPageWidget(
                userid:
                    params.getParam<String>('userid', ParamType.String, true),
                userd: params.getParam<String>('userd', ParamType.String, true),
            ...
            FFRoute(
              ...
              builder: (context, params) => CreateReviewWidget(
                placeid: params.getParam('placeid', ParamType.String),
            ...
            FFRoute(
              ...
              builder: (context, params) => HomePageWidget(
                isrestaurantincollection:
                    params.getParam('isrestaurantincollection', ParamType.bool),
              ),
            ),
            FFRoute(
              name: 'restaurantpage',
              ...
              builder: (context, params) => RestaurantpageWidget(
                ...
                wheelchairentrance:
                    params.getParam('wheelchairentrance', ParamType.bool),
                imageurl: params.getParam('imageurl', ParamType.String),
                pricelevel: params.getParam('pricelevel', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'filterpage',
              ...
              builder: (context, params) => FilterpageWidget(
                isrestaurantincollection:
                    params.getParam('isrestaurantincollection', ParamType.bool),
                filters: params.getParam('filters', ParamType.String),
              ),
            )
